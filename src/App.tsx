    ...
    >
      ...
      {project.thumbnail ? (
        <img 
          src={project.thumbnail} 
          alt={project.title} 
          className={`w-full h-full absolute inset-0 opacity-80 group-hover:opacity-100 group-hover:scale-105 transition-all duration-700 ${project.thumbnailClass || 'object-cover object-top'}`}
          referrerPolicy="no-referrer"
        />
      ) : (
